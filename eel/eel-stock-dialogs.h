...
/* Dialog for cancelling something that normally is fast enough not to need a
 * dialog. */
...
GtkDialog *eel_create_question_dialog(const char *primary_text,
                                      const char *secondary_text,
                                      const char *answer_one, int response_one,
                                      const char *answer_two, int response_two,
                                      GtkWindow *parent);
