...
G_DECLARE_FINAL_TYPE(NautilusFileUndoInfoExt, nautilus_file_undo_info_ext,
                     NAUTILUS, FILE_UNDO_INFO_EXT, NautilusFileUndoInfo)
...
#define NAUTILUS_TYPE_FILE_UNDO_INFO_RENAME                                    \
  nautilus_file_undo_info_rename_get_type()
G_DECLARE_FINAL_TYPE(NautilusFileUndoInfoRename, nautilus_file_undo_info_rename,
                     NAUTILUS, FILE_UNDO_INFO_RENAME, NautilusFileUndoInfo)
...
/* batch rename */
#define NAUTILUS_TYPE_FILE_UNDO_INFO_BATCH_RENAME                              \
  nautilus_file_undo_info_batch_rename_get_type()
G_DECLARE_FINAL_TYPE(NautilusFileUndoInfoBatchRename,
                     nautilus_file_undo_info_batch_rename, NAUTILUS,
                     FILE_UNDO_INFO_BATCH_RENAME, NautilusFileUndoInfo)
...
/* starred files */
#define NAUTILUS_TYPE_FILE_UNDO_INFO_STARRED                                   \
  (nautilus_file_undo_info_starred_get_type())
G_DECLARE_FINAL_TYPE(NautilusFileUndoInfoStarred,
                     nautilus_file_undo_info_starred, NAUTILUS,
...
/* trash */
#define NAUTILUS_TYPE_FILE_UNDO_INFO_TRASH                                     \
  (nautilus_file_undo_info_trash_get_type())
G_DECLARE_FINAL_TYPE(NautilusFileUndoInfoTrash, nautilus_file_undo_info_trash,
                     NAUTILUS, FILE_UNDO_INFO_TRASH, NautilusFileUndoInfo)
...
G_DECLARE_FINAL_TYPE(NautilusFileUndoInfoRecPermissions,
                     nautilus_file_undo_info_rec_permissions, NAUTILUS,
                     FILE_UNDO_INFO_REC_PERMISSIONS, NautilusFileUndoInfo)
...
#define NAUTILUS_TYPE_FILE_UNDO_INFO_PERMISSIONS                               \
  nautilus_file_undo_info_permissions_get_type()
G_DECLARE_FINAL_TYPE(NautilusFileUndoInfoPermissions,
                     nautilus_file_undo_info_permissions, NAUTILUS,
                     FILE_UNDO_INFO_PERMISSIONS, NautilusFileUndoInfo)
...
#define NAUTILUS_TYPE_FILE_UNDO_INFO_OWNERSHIP                                 \
  nautilus_file_undo_info_ownership_get_type()
G_DECLARE_FINAL_TYPE(NautilusFileUndoInfoOwnership,
                     nautilus_file_undo_info_ownership, NAUTILUS,
                     FILE_UNDO_INFO_OWNERSHIP, NautilusFileUndoInfo)
...
/* extract */
#define NAUTILUS_TYPE_FILE_UNDO_INFO_EXTRACT                                   \
  nautilus_file_undo_info_extract_get_type()
G_DECLARE_FINAL_TYPE(NautilusFileUndoInfoExtract,
                     nautilus_file_undo_info_extract, NAUTILUS,
                     FILE_UNDO_INFO_EXTRACT, NautilusFileUndoInfo)
...
/* compress */
#define NAUTILUS_TYPE_FILE_UNDO_INFO_COMPRESS                                  \
  nautilus_file_undo_info_compress_get_type()
G_DECLARE_FINAL_TYPE(NautilusFileUndoInfoCompress,
                     nautilus_file_undo_info_compress, NAUTILUS,
                     FILE_UNDO_INFO_COMPRESS, NautilusFileUndoInfo)
