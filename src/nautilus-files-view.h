...
G_DECLARE_DERIVABLE_TYPE(NautilusFilesView, nautilus_files_view, NAUTILUS,
                         FILES_VIEW, GtkGrid)
...
struct _NautilusFilesViewClass {
   ...
   * It must be replaced by each subclass.
   */
  void (*add_files)(NautilusFilesView *view, GList *files);
  void (*remove_file)(NautilusFilesView *view, NautilusFile *file,
   ...
   * It must be replaced by each subclass.
   */
  void (*file_changed)(NautilusFilesView *view, NautilusFile *file,
                       NautilusDirectory *directory);
   ...
   */
  void (*end_loading)(NautilusFilesView *view, gboolean all_files_seen);
  ...
  void (*set_selection)(NautilusFilesView *view, GList *selection);
  ...
  void (*bump_zoom_level)(NautilusFilesView *view, int zoom_increment);
   ...
   */
  int (*compare_files)(NautilusFilesView *view, NautilusFile *a,
                       NautilusFile *b);
  ...
  /* Scroll the view so that the file specified by the uri is at the top
     of the view */
  void (*scroll_to_file)(NautilusFilesView *view, const char *uri);
