...
#define NAUTILUS_GTK_PLACES_VIEW(obj)                                          \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), NAUTILUS_TYPE_GTK_PLACES_VIEW,            \
                              NautilusGtkPlacesView))
#define NAUTILUS_GTK_PLACES_VIEW_CLASS(klass)                                  \
  (G_TYPE_CHECK_CLASS_CAST((klass), NAUTILUS_TYPE_GTK_PLACES_VIEW,             \
...
#define NAUTILUS_IS_GTK_PLACES_VIEW_CLASS(klass)                               \
  (G_TYPE_CHECK_CLASS_TYPE((klass), NAUTILUS_TYPE_GTK_PLACES_VIEW))
#define NAUTILUS_GTK_PLACES_VIEW_GET_CLASS(obj)                                \
  (G_TYPE_INSTANCE_GET_CLASS((obj), NAUTILUS_TYPE_GTK_PLACES_VIEW,             \
                             NautilusGtkPlacesViewClass))
...
struct _NautilusGtkPlacesViewClass {
  ...
  void (*open_location)(NautilusGtkPlacesView *view, GFile *location,
