...
G_DEFINE_TYPE(NautilusSpecialLocationBar, nautilus_special_location_bar,
              GTK_TYPE_INFO_BAR)

static void set_special_location(NautilusSpecialLocationBar *bar,
    ...
    case NAUTILUS_SPECIAL_LOCATION_TEMPLATES: {
        message = g_strdup(_("Put files in this folder to use them as templates "
                             "for new documents."));
        learn_more_markup =
            g_strdup(_("<a href=\"help:gnome-help/files-templates\" title=\"GNOME "
    ...
    case NAUTILUS_SPECIAL_LOCATION_SCRIPTS: {
        message = g_strdup(
                      _("Executable files in this folder will appear in the Scripts menu."));
    }
    break;
    ...
    if (learn_more_markup) {
        gtk_label_set_markup(GTK_LABEL(bar->learn_more_label), learn_more_markup);
...
static void nautilus_special_location_bar_set_property(GObject *object,
        guint prop_id,
        const GValue *value,
        GParamSpec *pspec) {
...
static void nautilus_special_location_bar_get_property(GObject *object,
        guint prop_id,
        GValue *value,
        GParamSpec *pspec) {
    NautilusSpecialLocationBar *bar;
...
static void nautilus_special_location_bar_class_init(
    NautilusSpecialLocationBarClass *klass) {
    ...
    g_object_class_install_property(
        object_class, PROP_SPECIAL_LOCATION,
        g_param_spec_enum("special-location", "special-location",
                          "special-location", NAUTILUS_TYPE_SPECIAL_LOCATION,
...
GtkWidget *nautilus_special_location_bar_new(NautilusSpecialLocation location) {
    return g_object_new(NAUTILUS_TYPE_SPECIAL_LOCATION_BAR, "message-type",
                        GTK_MESSAGE_QUESTION, "special-location", location, NULL);
}
